...
- Current ComfyUI version: v0.16.3 (pinned in `nix/versions.nix`)
...
- CUDA: Pre-built wheels from pytorch.org with CUDA 12.8 runtime bundled (no separate toolkit needed); supports Pascal through Hopper
